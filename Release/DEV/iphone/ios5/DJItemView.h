...
@property (nonatomic, retain) IBOutlet UITableViewCell *cell_track;
@property (nonatomic, retain) IBOutlet UIButton *follow_btn;
@property (nonatomic, retain) IBOutlet UIButton *listen_btn;
@property (nonatomic, retain) IBOutlet UIButton *buy_btn;
@property (nonatomic, retain) IBOutlet UILabel *lbl_dj;
@property (nonatomic, retain) IBOutlet UILabel *lbl_upcoming;
@property (nonatomic, retain) IBOutlet UILabel *lbl_similar;
@property (nonatomic, retain) IBOutlet UILabel *lbl_notifications;
@property (nonatomic, retain) IBOutlet UILabel *lbl_web_site;
@property (nonatomic, retain) IBOutlet UILabel *lbl_music;
