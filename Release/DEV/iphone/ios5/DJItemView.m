...
@synthesize djs=_djs;
@synthesize cell_track=_cell_track;
@synthesize listen_btn=_listen_btn;
@synthesize buy_btn=_buy_btn;
@synthesize lbl_dj=_lbl_dj;
@synthesize lbl_upcoming=_lbl_upcoming;
@synthesize lbl_similar=_lbl_similar;
@synthesize lbl_notifications=_lbl_notifications;
@synthesize lbl_web_site=_lbl_web_site;
@synthesize lbl_music=_lbl_music;
...
- (void) setBG: (UIView *)v
{
    ...
    {
        [ self setBG:[ v.subviews objectAtIndex:i ] ];
    }
}
...
- (void)viewDidLoad
{
    ...
    self.lbl_notifications.backgroundColor = [ UIColor blackColor ];
    self.lbl_notifications.textColor = [ UIColor whiteColor ];
    
    self.lbl_upcoming.backgroundColor = [ UIColor blackColor ];
    self.lbl_upcoming.textColor = [ UIColor whiteColor ];
    
    self.lbl_similar.backgroundColor = [ UIColor blackColor ];
    self.lbl_similar.textColor = [ UIColor whiteColor ];
    
    self.lbl_dj.backgroundColor = [ UIColor blackColor ];
    self.lbl_dj.textColor = [ UIColor whiteColor ];
    
    self.lbl_music.backgroundColor = [ UIColor blackColor ];
    self.lbl_music.textColor = [ UIColor whiteColor ];

    self.tv.backgroundColor = [ UIColor blackColor ];
    
    
#if 0
    self.follow_btn.titleLabel.textColor = [ UIColor whiteColor ];
    self.follow_btn.backgroundColor = [ UIColor blackColor ];
    [ [ self.follow_btn layer ] setCornerRadius:8.0f ];
    [ [ self.follow_btn layer ] setBorderColor:[ [ UIColor whiteColor ] CGColor ] ];
    [ [ self.follow_btn layer ] setMasksToBounds:YES ];
    [ [ self.follow_btn layer ] setBorderWidth:1.0f ];
#endif
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( section == 0 )
    {
        ...
        UIImage *imgAll = [ UIImage imageNamed:@"deadmau5.jpg" ];
