...
DJ_LIST =  ["DJ_LIST.txt", "https://spreadsheets.google.com/feeds/cells/0AuRz1oxD7nNEdDZhNzVRUEptX3J1MlpPVXBFRmpRVnc/od7/public/basic", 2, 67 ]

# TO SYNC THIS SHEET, you must republish the sheet in google docs and restore from None...
DJ_SCHEDULE = [ "DJ_SCHEDULE.txt", "https://spreadsheets.google.com/feeds/cells/0AuRz1oxD7nNEdDZhNzVRUEptX3J1MlpPVXBFRmpRVnc/od4/public/basic" ]
...
if DJ_SCHEDULE:
        ...
        if os.path.exists( DJ_SCHEDULE[0] ):
                f = open( DJ_SCHEDULE[0] )
                st = f.read()
                f.close()
        ...
        # try the url...
                ...
                # get the contents of sheet...
                f = urllib.urlopen( DJ_SCHEDULE[1] )
                st = f.read()
		f = open (DJ_SCHEDULE[0])
                f.write(st)
                f.flush()
