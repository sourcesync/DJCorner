...
@property (atomic, retain) VenueItemView *venue_view;
...
@property (nonatomic, assign) BOOL showing_event_modal;
@property (nonatomic, assign) BOOL showing_dj_modal;
@property (nonatomic, assign) BOOL showing_venue_modal;
