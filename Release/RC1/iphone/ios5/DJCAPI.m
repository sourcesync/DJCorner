...
-(BOOL)     get_venues:(NSString *)searchrx:(NSDictionary *)paging
{
    //self.Now=10;;
    //NSArray *args = nil; //[ NSArray arrayWithObjects:djid,nil];
    NSArray *args = [ NSArray arrayWithObjects:searchrx,paging,nil];
    return [self ExecMethod:@"get_venues" andParams:args withID:@"11" ];
}
