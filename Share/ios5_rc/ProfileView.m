...
- (void)viewDidLoad
{
    ...
    //self.btn.titleLabel.text=[LocalizedManager localizedString:@"stop_music"];
    //self.bt_contact_feedback.titleLabel.text=[LocalizedManager localizedString:@"contact_feedback"];
    //self.bt_upgrade.titleLabel.text=[LocalizedManager localizedString:@"upgrade"];
...
-(IBAction)localization:(id)sender
{
    ...
    NSString *currentLanguage=[LocalizedManager selectedLanguage];
    if([currentLanguage isEqualToString:@"en"])
    {
        [LocalizedManager setSelectedLanguage:@"es"];
    }
    else if([currentLanguage isEqualToString:@"es"])
    {
        [LocalizedManager setSelectedLanguage:@"zh-Hans"];
    }
    else
    {
        [LocalizedManager setSelectedLanguage:@"en"];
    }
     */
