package
{
	...
	public class videocube extends Sprite
	{
		...
		private var pathAnim:away3d.animators.PathAnimator = null;
		...
		[Embed(source="/../assets/widget.swf")]
		private var DrawToolEmbedded:Class;
		private var swfURL:String = "http://www.theuniverseofallthings.com/widget.swf";
		
		public function videocube()
		{
			super();
			...
			//vector[0] = new Vector3D(-1000, -1000, -2000);
			//vector[1] = new Vector3D(-1000, 0, 0);
			//vector[2] = new Vector3D(1000, 0, 0);
			//vector[0] = new Vector3D(0, 0, -3000);
			//vector[1] = new Vector3D(0, 0, -2500);
			//vector[2] = new Vector3D(0, 0, -2000);
			vector[0] = new Vector3D(100, 0, 0);
			vector[1] = new Vector3D(100, 0, 0);
			vector[2] = new Vector3D(0, 0, 0);
			var p:Path = new Path( vector );
			//this.pathAnim = new away3d.animators.PathAnimator( p, this.cube, null, true,null, null );
			//this.pathAnim.
			
			//gw
			//var topMaterial:VideoMaterial = new VideoMaterial(
			//	new DrawToolEmbedded(), {lockW:320, lockH:240, interactive:true, smooth:true, precision:5});
			
			var frontMaterial:VideoMaterial = new VideoMaterial( swfURL, //new DrawToolEmbedded(), // videoURL,
				256,true,true,null);
			
			var frontPlane:Plane = new Plane( frontMaterial, 100, 100, 2, 2,false);
