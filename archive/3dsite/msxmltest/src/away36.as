package {
	...
	public class away36 extends Sprite {
		...
		private function init3D():void {
			...
			trace("init stage " + stage.stageWidth + " " + stage.stageHeight);
...
//This should produce a scene that is rotated about the y-axis with a sphere that rotates in the opposite direction, also about its y-axis. Click on the im