package
{
	...
	public class pathtest extends Sprite
	{
		...
		public function pathtest()
		{
			...
			vector[2] = new Vector3D(100, 0, 0);
			
			vector[3] = new Vector3D(100, 0, 0);
			vector[4] = new Vector3D(100, 100, 0);
			vector[5] = new Vector3D(100, 100, 0);
			
			var p:Path = new Path( vector );
			this.pathAnim = new away3d.animators.PathAnimator( p, this.icube, null, true,null, null );
			//this.pathAnim.
